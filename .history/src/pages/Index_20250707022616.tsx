...
import { Github, ExternalLink, Mail, Linkedin, Menu, X, ChevronDown, MapPin, Calendar, Award, Trophy, TwitterIcon, Code2 } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      github: "https://github.com/PraTEEkgUpTa2/Quick_Deck",
      demo: "https://quick-deck-beta.vercel.app/",
    ...
    },
    {
      ...
      github: "https://github.com/PraTEEkgUpTa2/Bill-Manager",
      demo: "https://bill-manager-alpha.vercel.app/",
    ...
    },
    {
      ...
      github: "https://github.com/PraTEEkgUpTa2/Motion",
      demo: "https://note-making-app-chi.vercel.app/",
      image: "https://i.ibb.co/27bP501M/bc2b971e-c6ca-4133-8f2e-ea681f841651.png"
    }
  ];
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center hover-target">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-16">
              <Button 
                ...
                asChild
              >
                <a href="mailto:prateekgupta23090@gmail.com" className="inline-flex items-center gap-3" target="_blank" rel="noopener noreferrer">
                  <Mail size={20} />
                  <span className="group-hover:transform group-hover:translate-x-1 transition-transform duration-300">
                    Say Hello
                  </span>
            ...
            <div className="flex justify-center gap-8">
              ...
              <a 
                href="https://leetcode.com/u/prateek_gupta245/" 
                target="_blank" 
                rel="noopener noreferrer"
                className={`${isDarkMode ? 'text-slate-muted hover:text-cyan-bright' : 'text-slate-500 hover:text-cyan-600'} transition-all duration-300 p-3 hover:transform hover:scale-110 hover-target`}
                aria-label="Follow on GitHub"
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            <div className={`flex flex-col sm:flex-row justify-between items-center pt-8 border-t ${isDarkMode ? 'border-slate-muted/20' : 'border-gray-200'} gap-4`}>
              <p className={`${isDarkMode ? 'text-slate-muted' : 'text-slate-500'} text-sm`}>
                Crafted with 💻, coffee ☕, and a dash of JavaScript
              </p>
              <div className="flex items-center gap-4">
                <span className={`${isDarkMode ? 'text-slate-muted' : 'text-slate-500'} text-sm`}>
                  Want to build something together? <a href="#contact" className="underline hover:text-cyan-400">Let's chat.</a>
                </span>
              </div>
            </div>
          </div>
