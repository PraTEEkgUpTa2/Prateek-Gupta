            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="animate-fade-in hover-target">
                ...
                <p className={`text-xl ${isDarkMode ? 'text-slate-muted' : 'text-slate-600'} mb-8 max-w-2xl leading-relaxed`}>
                  I'm a Computer Science student at NIT Rourkela specializing in full-stack development with React, Next.js, and Node.js. 
                  I create performant, scalable web applications and have experience optimizing performance and enhancing user engagement.
                </p>
              ...
              <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-8 md:gap-20 -mt-12 md:-mt-4 animate-fade-in">
                <div className="relative hover-target">
                  <div className="w-[220px] h-[220px] rounded-full overflow-hidden border-4 border-cyan-bright/20 shadow-2xl shadow-cyan-bright/10 hover:shadow-cyan-bright/20 transition-all duration-500 hover:scale-105">
                    <img 
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div className="space-y-6">
                <p className={`text-lg ${isDarkMode ? 'text-slate-muted' : 'text-slate-600'} leading-relaxed`}>
                  I'm a final-year Computer Science student at NIT Rourkela with a passion for building scalable web applications. 
                ...
                <p className={`text-lg ${isDarkMode ? 'text-slate-muted' : 'text-slate-600'} leading-relaxed`}>
                  Currently maintaining a 7.83 CGPA while actively participating in coding competitions and building projects 
