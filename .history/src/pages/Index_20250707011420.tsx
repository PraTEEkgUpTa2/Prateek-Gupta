            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="flex justify-center lg:justify-end animate-fade-in">
                <div className="relative hover-target">
                  <div className="w-80 h-80 rounded-full overflow-hidden border-4 border-cyan-bright/20 shadow-2xl shadow-cyan-bright/10 hover:shadow-cyan-bright/20 transition-all duration-500 hover:scale-105">
                    <img 
                  ...
                  <div className="absolute -top-2 -right-4 w-20 h-20 border-4 border-cyan-bright rounded-full opacity-30"></div>
