            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="animate-fade-in hover-target">
                ...
                <p className={`text-xl ${isDarkMode ? 'text-slate-muted' : 'text-slate-600'} mb-8 max-w-2xl leading-relaxed`}>
                  I'm a recent graduate from NIT Rourkela with a strong focus on full-stack web development. I specialize in building performant and scalable web applications using modern technologies like React, Next.js, and Node.js. 
